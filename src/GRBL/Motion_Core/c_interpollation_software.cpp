...
NGC_RS274::NGC_Binary_Block Motion_Core::Software::Interpollation::previous_state = NGC_RS274::NGC_Binary_Block();
...
void Motion_Core::Software::Interpollation::load_block(NGC_RS274::NGC_Binary_Block *block)
{
...
void Motion_Core::Software::Interpollation::load_buffer()
{
	Motion_Core::Segment::Arbitrator::st_prep_buffer();
}
...
void Motion_Core::Software::Interpollation::_mc_arc(uint8_t is_clockwise_arc, NGC_RS274::NGC_Binary_Block *target_block)
{
	...
	/ sqrt(c_settings::settings.arc_tolerance * (2 * (*target_block->arc_values.Radius) - c_settings::settings.arc_tolerance)));
