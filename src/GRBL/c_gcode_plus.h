...
#ifndef __C_GCODE_H__
#define __C_GCODE_H__
#include <stdint.h>
...
class c_gcode
{
	//variables
	public:
		static NGC_RS274::NGC_Binary_Block test_block;
	...
	static parser_state_t gc_state;
	...
	static void gc_default_block();

	// Execute one block of rs275/ngc/g-code
	static uint8_t gc_execute_line(char *line);
	static uint8_t gc_execute_block(uint8_t block_idx);
