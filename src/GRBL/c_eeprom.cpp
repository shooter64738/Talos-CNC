...
void c_eeprom::memcpy_to_eeprom_with_checksum(void *dst, const void *src, size_t size)
{
	//eeprom_write_block(src, dst, size);
	//eeprom_write_byte(dst + size, calck_checksum(src, size));
}

bool c_eeprom::memcpy_from_eeprom_with_checksum(void *dst, const void *src, size_t size)
{
