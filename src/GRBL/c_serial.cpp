...
uint8_t c_serial::serial_get_rx_buffer_available()
{
...
uint8_t c_serial::serial_get_rx_buffer_count()
{
    uint8_t rtail = serial_rx_buffer_tail; // Copy to limit multiple calls to volatile
    if (serial_rx_buffer_head >= rtail)
    {
...
uint8_t c_serial::serial_get_tx_buffer_count()
{
...
void c_serial::serial_write(uint8_t data)
{
    ...
    while (next_head == serial_tx_buffer_tail)
    {
        ...
        if (c_system::sys_rt_exec_state & EXEC_RESET)
        {
            return;
...
void c_serial::serial_rx_event(uint8_t data)
{
    ...
    switch (data)
    {
		#ifdef RTC_H_
			case CMD_MPG_JOG_X:
				SYS_JOG_MPG_AXIS = X_STEP_BIT;
				break;
			case CMD_MPG_JOG_Y:
				SYS_JOG_MPG_AXIS = Y_STEP_BIT;
				break;
		#endif // RTC_H_
        ...
        case CMD_STATUS_REPORT:
            c_system::system_set_exec_state_flag(EXEC_STATUS_REPORT);
            break; // Set as true
            ...
            { // Real-time control characters are extended ACSII only.
                switch (data)
                {
                    case CMD_SAFETY_DOOR:
                        c_system::system_set_exec_state_flag(EXEC_SAFETY_DOOR);
                        break; // Set as true
                    case CMD_JOG_CANCEL:
                        if (c_system::sys.state & STATE_JOG)
                        { // Block all other states from invoking motion cancel.
                            c_system::system_set_exec_state_flag(EXEC_MOTION_CANCEL);
                        }
                        break;
//#ifdef DEBUG
                        //case CMD_DEBUG_REPORT:
                        //{   uint8_t sreg = SREG; cli(); bit_true(c_system::sys_rt_exec_debug,EXEC_DEBUG_REPORT); SREG = sreg;}break;
//#endif
                    case CMD_FEED_OVR_RESET:
                        c_system::system_set_exec_motion_override_flag(EXEC_FEED_OVR_RESET);
                        break;
                    case CMD_FEED_OVR_COARSE_PLUS:
                        c_system::system_set_exec_motion_override_flag(EXEC_FEED_OVR_COARSE_PLUS);
                        break;
                    case CMD_FEED_OVR_COARSE_MINUS:
                        c_system::system_set_exec_motion_override_flag(EXEC_FEED_OVR_COARSE_MINUS);
                        break;
                    case CMD_FEED_OVR_FINE_PLUS:
                        c_system::system_set_exec_motion_override_flag(EXEC_FEED_OVR_FINE_PLUS);
                        break;
                    case CMD_FEED_OVR_FINE_MINUS:
                        c_system::system_set_exec_motion_override_flag(EXEC_FEED_OVR_FINE_MINUS);
                        break;
                    case CMD_RAPID_OVR_RESET:
                        c_system::system_set_exec_motion_override_flag(EXEC_RAPID_OVR_RESET);
                        break;
                    case CMD_RAPID_OVR_MEDIUM:
                        c_system::system_set_exec_motion_override_flag(EXEC_RAPID_OVR_MEDIUM);
                        break;
                    case CMD_RAPID_OVR_LOW:
                        c_system::system_set_exec_motion_override_flag(EXEC_RAPID_OVR_LOW);
                        break;
                    case CMD_SPINDLE_OVR_RESET:
                        c_system::system_set_exec_accessory_override_flag(EXEC_SPINDLE_OVR_RESET);
                        break;
                    case CMD_SPINDLE_OVR_COARSE_PLUS:
                        c_system::system_set_exec_accessory_override_flag(EXEC_SPINDLE_OVR_COARSE_PLUS);
                        break;
                    case CMD_SPINDLE_OVR_COARSE_MINUS:
                        c_system::system_set_exec_accessory_override_flag(EXEC_SPINDLE_OVR_COARSE_MINUS);
                        break;
                    case CMD_SPINDLE_OVR_FINE_PLUS:
                        c_system::system_set_exec_accessory_override_flag(EXEC_SPINDLE_OVR_FINE_PLUS);
                        break;
                    case CMD_SPINDLE_OVR_FINE_MINUS:
                        c_system::system_set_exec_accessory_override_flag(EXEC_SPINDLE_OVR_FINE_MINUS);
                        break;
                    ...
                    case CMD_COOLANT_FLOOD_OVR_TOGGLE:
                        c_system::system_set_exec_accessory_override_flag(EXEC_COOLANT_FLOOD_OVR_TOGGLE);
                        break;
                    case CMD_COOLANT_MIST_OVR_TOGGLE:
                        c_system::system_set_exec_accessory_override_flag(EXEC_COOLANT_MIST_OVR_TOGGLE);
                        break;
...
void c_serial::serial_reset_read_buffer()
{
