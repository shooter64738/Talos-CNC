...
NGC_RS274::NGC_Binary_Block*c_gcode_buffer::get()
{
	...
	if (c_gcode_buffer::buffer_tail == c_gcode_buffer::buffer_head && !Events::Data::get_event(Events::Data::e_event_type::NGC_buffer_full))
	{
	...
	Events::Data::clear_event(Events::Data::e_event_type::NGC_buffer_full);
...
* \return int16_t
*/
int16_t c_gcode_buffer::add( char * pntr_buffer)
{
	...
	*/
	...
	NGC_RS274::Interpreter::Processor::Line = pntr_buffer;
	uint16_t return_value = NGC_RS274::Interpreter::Processor::process_line(local_block);
	...
	if (c_gcode_buffer::buffer_head == c_gcode_buffer::buffer_tail)
	{
		...
		Events::Data::set_event(Events::Data::e_event_type::NGC_buffer_full);
