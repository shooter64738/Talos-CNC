...
#ifndef __MACHINE_PARAMETERS_PROCESS_H__
#define __MACHINE_PARAMETERS_PROCESS_H__
#define HIGH_SPEED_PECK_DISTANCE 5114
#include <stdint.h>
namespace Talos
{
	class Machine_Parameters_Process
	{
		//variables
		public:
		protected:
	...
	}; //Machine_Parameters_Process
};
#endif //__MACHINE_PARAMETERS_PROCESS_H__
