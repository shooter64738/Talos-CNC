...
public:
	...
	static void process_status(s_status_message * status);

protected:
private:
	static void __critical_type(s_status_message *status, e_status_message::e_critical message);
	static void __data_type(s_status_message *status, e_status_message::e_data message);
	static void __informal_type(s_status_message *status, e_status_message::e_informal message);
	static void __warning_type(s_status_message *status, e_status_message::e_warning message);
