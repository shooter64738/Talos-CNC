...
void Talos::Shared::FrameWork::Events::Report::__write_header(s_ngc_block block)
{
...
void Talos::Shared::FrameWork::Events::Report::____group(uint8_t counter, uint16_t * pointer, char group_name)
{
...
void Talos::Shared::FrameWork::Events::Report::____word(uint8_t counter, float * pointer)
{
	uint8_t columns = 4;
	//write the name tags
	for (int i = 0; i < counter; i++)
...
void Talos::Shared::FrameWork::Events::Report::__write_eol()
{
	StartUp::string_writer("\r\n");
}