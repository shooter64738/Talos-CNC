...
e_record_types c_data_handler::cdh_r_get_message_type(c_ring_buffer<char> * buffer)
{
...
void c_data_handler::cdh_r_read()
{
...
void c_data_handler::__cdh_r_close_read()
{
	if (dvc_source->active_record->record_type == e_record_types::System)
	{
		...
		{
			//Talos::Kernel::Error::raise_error(BASE, __cdh_close_read__, 1, 0);
		}
