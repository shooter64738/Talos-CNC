...
* c_LcdPcf8574.h
*
* Created: 11/25/2018 5:38:21 PM
* Author: jeff_d
*/


#ifndef __C_LCDPCF8574_H__
#define __C_LCDPCF8574_H__
...
class c_LcdPcf8574
{
	...
	static void lcd_init(uint8_t dispAttr);
	...
	*/
	...
	static int lcd_getxy(void);
	/**
	@brief    Set illumination pin
	@param    void
	@return   none
	*/
	static void lcd_led(uint8_t onoff);
	...
	*/
	...
	@see      lcd_puts_P
	*/
	static void lcd_puts_p(const char *progmem_s);
	...
	*/
	...
	@return none
	*/
	static void lcd_clear_CGRAM (void);
	...
	*/
	static uint8_t lcd_create_custom_char (uint8_t charnum, const uint8_t * values);
	...
	*/
	...
	c_LcdPcf8574();
	~c_LcdPcf8574();
	c_LcdPcf8574( const c_LcdPcf8574 &c );
	c_LcdPcf8574& operator=( const c_LcdPcf8574 &c );

}; //c_LcdPcf8574

#endif //__C_LCDPCF8574_H__
