...
, uint8_t state, uint8_t sub_state, uint8_t type)
{
	...
	Talos::Shared::c_cache_data::pntr_status_record->position[0]=123;
	Talos::Shared::c_cache_data::pntr_status_record->position[1]=456;
	Talos::Shared::c_cache_data::pntr_status_record->position[2]=789;
	Talos::Shared::c_cache_data::pntr_status_record->position[3]=102;
...
void Talos::Motion::Data::System::Type::__process(s_system_message *status)
{
...
void Talos::Motion::Data::System::Type::__critical(s_system_message *status, e_system_message::messages::e_critical message)
{
...
void Talos::Motion::Data::System::Type::__data(s_system_message *status, e_system_message::messages::e_data message)
{
...
void Talos::Motion::Data::System::Type::__informal(s_system_message *status, e_system_message::messages::e_informal message)
{
...
void Talos::Motion::Data::System::Type::__warning(s_system_message *status, e_system_message::messages::e_warning message)
{
...
void Talos::Motion::Data::System::Origin::__coordinator(s_system_message *status, e_system_message::messages::e_warning message)
{
	Talos::Shared::FrameWork::Events::extern_system_events.event_manager.set((int)s_system_events::e_event_type::SystemCritical);
	//Talos::Shared::FrameWork::Error::Handler::extern_pntr_error_handler(NULL, error);
}
void Talos::Motion::Data::System::Origin::__host(s_system_message *status, e_system_message::messages::e_warning message)
{

}
void Talos::Motion::Data::System::Origin::__motion(s_system_message *status, e_system_message::messages::e_warning message)
{

}
void Talos::Motion::Data::System::Origin::__spindle(s_system_message *status, e_system_message::messages::e_warning message)
{

}
void Talos::Motion::Data::System::Origin::__peripheral(s_system_message *status, e_system_message::messages::e_warning message)
{
