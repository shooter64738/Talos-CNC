...
s_bit_flag_controller<uint32_t> Talos::Motion::Events::Report::event_manager;
...
void Talos::Motion::Events::Report::process()
{
	...
	if (Talos::Motion::Events::Report::event_manager._flag>0)
	{
		if (Talos::Motion::Events::Report::event_manager.get_clr((int) Events::Report::e_event_type::StatusMessage))
		{
			...
			//if (Talos::Shared::c_cache_data::pntr_system_record != NULL)
			//{
			//	rpt_serial->print_string("Sta:{Mot}");; __write_eol();
			//	rpt_serial->print_string(" Rtp:"); rpt_serial->print_int32((int)Talos::Shared::c_cache_data::pntr_system_record->__rec_type__); __write_eol();
			//	rpt_serial->print_string(" Org:"); rpt_serial->print_int32(Talos::Shared::c_cache_data::pntr_system_record->origin); __write_eol();
			//	rpt_serial->print_string(" Trg:"); rpt_serial->print_int32(Talos::Shared::c_cache_data::pntr_system_record->target); __write_eol();
			//	rpt_serial->print_string(" Msg:"); rpt_serial->print_int32(Talos::Shared::c_cache_data::pntr_system_record->message); __write_eol();
			//	rpt_serial->print_string(" Ste:"); rpt_serial->print_int32(Talos::Shared::c_cache_data::pntr_system_record->state); __write_eol();
			//	rpt_serial->print_string(" Sst:"); rpt_serial->print_int32(Talos::Shared::c_cache_data::pntr_system_record->sub_state); __write_eol();
			//	rpt_serial->print_string(" RxF:"); rpt_serial->print_int32(Talos::Shared::c_cache_data::pntr_system_record->rx_from); __write_eol();
	...
	if (Talos::Shared::FrameWork::Events::Router.inquire.event_manager._flag>0)
	{
...
void Talos::Motion::Events::Report::__pad_left(float value, uint8_t padcount, uint8_t decimals, char pad_char)
{
...
void Talos::Motion::Events::Report::__write_eol()
{
	rpt_serial->print_string("\r\n");
}