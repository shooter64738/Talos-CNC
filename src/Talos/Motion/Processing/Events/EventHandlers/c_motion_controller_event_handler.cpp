...
void Talos::Motion::Events::MotionController::process()
{
	...
	{
		if (Talos::Shared::FrameWork::Data::System::send((int)e_system_message::messages::e_warning::testwarning
			, (int)e_system_message::e_status_type::Warning
			, Talos::Shared::FrameWork::StartUp::cpu_type.Motion
			, Talos::Shared::FrameWork::StartUp::cpu_type.Coordinator
			, (int)e_system_message::e_status_state::motion::e_state::System_Error
			, ((int)e_system_message::e_status_state::motion::e_sub_state::Error_Axis_Drive_Fault_X + faulting_axis_id)
