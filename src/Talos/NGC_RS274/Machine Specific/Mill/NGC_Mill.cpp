...
int NGC_RS274::Interpreter::NGC_Machine_Specific::error_check_canned_cycle()
{
	...
	if (NGC_RS274::Interpreter::Processor::worker_block.g_group[NGC_RS274::Groups::G::RETURN_MODE_CANNED_CYCLE] != NGC_RS274::G_codes::CANNED_CYCLE_RETURN_TO_R
	&& NGC_RS274::Interpreter::Processor::worker_block.g_group[NGC_RS274::Groups::G::RETURN_MODE_CANNED_CYCLE] != NGC_RS274::G_codes::CANNED_CYCLE_RETURN_TO_Z)
	{
	...
	if (NGC_RS274::Interpreter::Processor::worker_block.word_defined_in_block_A_Z.get(A_WORD_BIT))
	return  NGC_RS274::Interpreter::Errors::CAN_CYLCE_ROTATIONAL_AXIS_A_DEFINED;
	if (NGC_RS274::Interpreter::Processor::worker_block.word_defined_in_block_A_Z.get(B_WORD_BIT))
	return  NGC_RS274::Interpreter::Errors::CAN_CYLCE_ROTATIONAL_AXIS_B_DEFINED;
	if (NGC_RS274::Interpreter::Processor::worker_block.word_defined_in_block_A_Z.get(C_WORD_BIT))
	...
	if (NGC_RS274::Interpreter::Processor::worker_block.g_group[NGC_RS274::Groups::G::Cutter_radius_compensation] != NGC_RS274::G_codes::CANCEL_CUTTER_RADIUS_COMPENSATION)
	...
	if (NGC_RS274::Interpreter::Processor::worker_block.word_defined_in_block_A_Z.get(L_WORD_BIT))
	{
		//L was defined, make sure it >1 and integer
		if (NGC_RS274::Interpreter::Processor::worker_block.block_word_values['L' - 65] < 2)
		...
		int mantissa = (NGC_RS274::Interpreter::Processor::worker_block.block_word_values['L' - 65] - (int)NGC_RS274::Interpreter::Processor::worker_block.block_word_values['L' - 65]) * 100;
		if (mantissa > 0)
	...
	if (!NGC_RS274::Interpreter::Processor::worker_block.any_linear_axis_was_defined())
	return  NGC_RS274::Interpreter::Errors::CAN_CYCLE_LINEAR_AXIS_UNDEFINED;

	//if Using R retract method (G99), make sure R was set.
	if (NGC_RS274::Interpreter::Processor::worker_block.g_group[NGC_RS274::Groups::G::RETURN_MODE_CANNED_CYCLE] == NGC_RS274::G_codes::CANNED_CYCLE_RETURN_TO_R)
	{
		if (!NGC_RS274::Interpreter::Processor::worker_block.word_defined_in_block_A_Z.get(R_WORD_BIT) && NGC_RS274::Interpreter::Processor::worker_block.get_value('R') == 0)
	...
	if (NGC_RS274::Interpreter::Processor::worker_block.g_group[NGC_RS274::Groups::G::Motion] == NGC_RS274::G_codes::CANNED_CYCLE_DRILLING_WITH_DWELL)
	{
		if (!NGC_RS274::Interpreter::Processor::worker_block.word_defined_in_block_A_Z.get(P_WORD_BIT) && NGC_RS274::Interpreter::Processor::worker_block.get_value('P') == 0)
...
int NGC_RS274::Interpreter::NGC_Machine_Specific::error_check_feed_mode(int gCode)
{
	...
	if (NGC_RS274::Interpreter::Processor::worker_block.get_g_code_value_x(NGC_RS274::Groups::G::Feed_rate_mode) == NGC_RS274::G_codes::FEED_RATE_MINUTES_PER_UNIT_MODE
		&& !NGC_RS274::Interpreter::Processor::worker_block.get_defined(('F')))
	...
	if (NGC_RS274::Interpreter::Processor::worker_block.get_g_code_value_x(NGC_RS274::Groups::G::Feed_rate_mode)
	== NGC_RS274::G_codes::FEED_RATE_UNITS_PER_ROTATION)
	{
		//Is the spindle on, or coming on at this line?
		if (NGC_RS274::Interpreter::Processor::worker_block.get_m_code_value_x(NGC_RS274::Groups::M::SPINDLE)
		...
		if (NGC_RS274::Interpreter::Processor::worker_block.block_word_values['S' - 65] == 0)
		{
	...
	if (NGC_RS274::Interpreter::Processor::worker_block.block_word_values['F' - 65] == 0 && gCode > 0)
	{
