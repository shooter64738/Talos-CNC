...
#define BASE_ERROR_G_ERROR 40
			static const uint8_t G_CODE_GROUP_NON_MODAL_ALREADY_SPECIFIED = 1 + BASE_ERROR_G_ERROR;
			static const uint8_t G_CODE_GROUP_NON_MODAL_AXIS_CANNOT_BE_SPECIFIED = 2 + BASE_ERROR_G_ERROR;
			static const uint8_t G_CODE_GROUP_MOTION_GROUP_ALREADY_SPECIFIED = 3 + BASE_ERROR_G_ERROR;
			static const uint8_t G_CODE_GROUP_PLANE_SELECTION_ALREADY_SPECIFIED = 4 + BASE_ERROR_G_ERROR;
			static const uint8_t G_CODE_GROUP_DISTANCE_MODE_ALREADY_SPECIFIED = 5 + BASE_ERROR_G_ERROR;
			static const uint8_t G_CODE_GROUP_FEED_RATE_MODE_ALREADY_SPECIFIED = 6 + BASE_ERROR_G_ERROR;
			static const uint8_t G_CODE_GROUP_UNITS_ALREADY_SPECIFIED = 7 + BASE_ERROR_G_ERROR;
			static const uint8_t G_CODE_GROUP_CUTTER_RADIUS_COMPENSATION_ALREADY_SPECIFIED = 8 + BASE_ERROR_G_ERROR;
			static const uint8_t G_CODE_GROUP_TOOL_LENGTH_OFFSET_ALREADY_SPECIFIED = 9 + BASE_ERROR_G_ERROR;
			static const uint8_t G_CODE_GROUP_RETURN_MODE_CANNED_CYCLE_ALREADY_SPECIFIED = 10 + BASE_ERROR_G_ERROR;
			static const uint8_t G_CODE_GROUP_COORDINATE_SYSTEM_SELECTION_ALREADY_SPECIFIED = 11 + BASE_ERROR_G_ERROR;
			static const uint8_t G_CODE_GROUP_PATH_CONTROL_MODE_ALREADY_SPECIFIED = 12 + BASE_ERROR_G_ERROR;

#define BASE_ERROR_M_ERROR BASE_ERROR_G_ERROR+20
