...
#define BASE_NOT_UNDERSTOOD 1000
#define BASE_ERROR_G_ERROR 40
#define BASE_ERROR_M_ERROR 60
#define BASE_ERROR_WORD_ERROR 100
#define BASE_CAN_CYCLE_ERROR 200
#define BASE_COORDINATE_ERROR 250
#define BASE_TOOL_OFFSET_ERROR 300
#define BASE_CUTTER_COMP_ERROR 350
#define BASE_PARSER_ERROR 400


enum class e_parsing_errors
{
	/*
	...
	*/
	...
	OK = 0, //<--Everything parsed fine
	MOTION_CANCELED_AXIS_VALUES_INVALID = 1,
	NO_AXIS_DEFINED_FOR_MOTION = 2,
	NO_FEED_RATE_SPECIFIED = 3,
	NO_FEED_RATE_SPECIFIED_FOR_UNIT_PER_MINUTE = 4,
	NO_SPINDLE_VALUE_FOR_UNIT_PER_ROTATION = 5,
	NO_SPINDLE_MODE_FOR_UNIT_PER_ROTATION = 6,

	MISSING_CIRCLE_OFFSET_IJ = 15,
	MISSING_CIRCLE_OFFSET_IK = 16,
	MISSING_CIRCLE_OFFSET_JK = 17,
	RADIUS_FORMAT_ARC_RADIUS_LESS_THAN_ZERO = 18,
	CENTER_FORMAT_ARC_RADIUS_ERROR_EXCEEDS_005 = 19,
	CENTER_FORMAT_ARC_RADIUS_ERROR_EXCEEDS_PERCENTAGE = 20,

	MISSING_CIRCLE_AXIS_XY = 30,
	MISSING_CIRCLE_AXIS_XZ = 31,
	MISSING_CIRCLE_AXIS_YZ = 32,
	ACTIVE_PLANE_UNSPECIFIED = 33,
	...
	G_CODE_GROUP_NON_MODAL_AXIS_CANNOT_BE_SPECIFIED = 2 + BASE_ERROR_G_ERROR,
	...
	*/
	...
	/*ADDRESS_VALUE_NOT_NUMERIC = 300,
	WORD_VALUE_TYPE_INVALID = 301,
	LINE_CONTAINS_NO_DATA = 302,
	ADDRESS_VALUE_PARAM_INVALID = 303,
	ADDRESS_VALUE_ERROR_UNSPECIFIED = 304,*/
