...
#define ALLOC_PLANE_ROTATION_ERROR_SIZE 100
...
#define  BASE_PLANE_ROTATION_ERROR (BASE_CUTTER_COMP_ERROR + ALLOC_TOOL_OFFSET_ERROR_SIZE)//700-799
#define  BASE_PARSER_ERROR         (BASE_PLANE_ROTATION_ERROR + ALLOC_CUTTER_COMP_ERROR_SIZE)//800-899
