...
#include "c_configuration_motion_controller.h"
...
uint8_t c_controller::load_defaults()
{
	...
	{
		Settings.hardware.steps_per_mm[i] = 160;
		Settings.hardware.acceleration[i] = (150.0 * 60 * 60);
		Settings.hardware.max_rate[i] = 12000;
