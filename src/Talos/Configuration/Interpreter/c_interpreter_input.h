...
#ifndef __C_CONFIGURATION_INTERPRETER_INPUT_H__
#define __C_CONFIGURATION_INTERPRETER_INPUT_H__
...
class c_parameters
{
	//variables
public:
	static s_interpreter_settings_encapsulation_configuration Settings;
protected:
private:
