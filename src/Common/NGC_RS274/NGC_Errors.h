...
#define BASE_ERROR 15
			static const uint8_t G_CODE_GROUP_NON_MODAL_ALREADY_SPECIFIED = NGC_RS274::Groups::G::NON_MODAL + BASE_ERROR;
			static const uint8_t G_CODE_GROUP_MOTION_GROUP_ALREADY_SPECIFIED = NGC_RS274::Groups::G::MOTION + BASE_ERROR;
			static const uint8_t G_CODE_GROUP_PLANE_SELECTION_ALREADY_SPECIFIED = NGC_RS274::Groups::G::PLANE_SELECTION + BASE_ERROR;
			static const uint8_t G_CODE_GROUP_DISTANCE_MODE_ALREADY_SPECIFIED = NGC_RS274::Groups::G::DISTANCE_MODE + BASE_ERROR;
			static const uint8_t G_CODE_GROUP_FEED_RATE_MODE_ALREADY_SPECIFIED = NGC_RS274::Groups::G::FEED_RATE_MODE + BASE_ERROR;
			static const uint8_t G_CODE_GROUP_UNITS_ALREADY_SPECIFIED = NGC_RS274::Groups::G::UNITS + 21;
			static const uint8_t G_CODE_GROUP_CUTTER_RADIUS_COMPENSATION_ALREADY_SPECIFIED = NGC_RS274::Groups::G::CUTTER_RADIUS_COMPENSATION + BASE_ERROR;
			static const uint8_t G_CODE_GROUP_TOOL_LENGTH_OFFSET_ALREADY_SPECIFIED = NGC_RS274::Groups::G::TOOL_LENGTH_OFFSET + BASE_ERROR;
			static const uint8_t G_CODE_GROUP_RETURN_MODE_CANNED_CYCLE_ALREADY_SPECIFIED = NGC_RS274::Groups::G::RETURN_MODE_CANNED_CYCLE + BASE_ERROR;
			static const uint8_t G_CODE_GROUP_COORDINATE_SYSTEM_SELECTION_ALREADY_SPECIFIED = NGC_RS274::Groups::G::COORDINATE_SYSTEM_SELECTION + BASE_ERROR;
			static const uint8_t G_CODE_GROUP_PATH_CONTROL_MODE_ALREADY_SPECIFIED = NGC_RS274::Groups::G::PATH_CONTROL_MODE + BASE_ERROR;
