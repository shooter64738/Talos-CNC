...
void Motion_Core::Segment::Arbitrator::cycle_hold()
{
	...
	if (Motion_Core::System::StepControl == 0)
	{
		...
		Motion_Core::c_processor::debug_serial.print_string("cycle hold\r");
		
		Motion_Core::c_processor::send_status(BinaryRecords::e_system_state_record_types::Motion_Idle
